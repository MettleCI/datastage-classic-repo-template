...
for each parameterset being managed.  Each parameterset to be managed is represented here as a subdirectory with the same name as
the parameterset.

Refer to [this page](http://docs.mettleci.io/parammgmt) for a full explanation of this feature.
