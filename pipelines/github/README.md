...
```
Example GitHub CI workflow files can be found in `/.github/workflows/`. 
...
See the documentation [here](https://docs.mettleci.io/github).

_(Data Migrators source reference: <DEVOPS_REPO_PATH>)_
